  ...
  return (
    <div className="flex flex-col md:flex-row gap-1 md:gap-10 pt-10">
      ...
      <div className="min-w-60">
        ...
        <div
          className={`border border-gray-300 pl-5 py-3 my-5 hidden ${
            showFilter ? "" : "hidden"
          } md:hidden `}
        >
      ...
      <div className="flex-1">
        <div className="flex flex-col md:flex-row justify-between text-base md:text-2xl mb-4 ">
          <div className="text-center items-center mx-auto">
          <Title text1={"ALL"} text2={"COLLECTION"} />
          </div>
          {/* product sort */}

          <select onChange={(e) => setSortType(e.target.value)} className="border-2 w-[10rem] rounded md:w-auto py-2 md:py-0 border-gray-300 text-sm px-2 ">
            <option value="relavant">Sort by: Latest</option>
